...
final class InternalFrameTitlePaneMaximizeButtonPainter extends AbstractRegionPainter {
    ...
    private RoundRectangle2D decodeRoundRect1() {
        roundRect.setRoundRect(decodeX(1.0f), 
                               decodeY(1.0f), 
                               decodeX(2.0f) - decodeX(1.0f), 
                               decodeY(1.9444444f) - decodeY(1.0f), 
                               8.6f, 8.6f); 
        return roundRect;
    }

    private RoundRectangle2D decodeRoundRect2() {
        roundRect.setRoundRect(decodeX(1.0526316f), 
                               decodeY(1.0555556f), 
                               decodeX(1.9473684f) - decodeX(1.0526316f), 
                               decodeY(1.8888888f) - decodeY(1.0555556f), 
                               6.75f, 6.75f); 
        return roundRect;
    }
    ...
    private Rectangle2D decodeRect1() {
            rect.setRect(decodeX(1.0f), 
                         decodeY(1.0f), 
                         decodeX(1.0f) - decodeX(1.0f), 
                         decodeY(1.0f) - decodeY(1.0f)); 
        return rect;
    }

    private Rectangle2D decodeRect2() {
            rect.setRect(decodeX(1.2165072f), 
                         decodeY(1.2790405f), 
                         decodeX(1.6746411f) - decodeX(1.2165072f), 
                         decodeY(1.3876263f) - decodeY(1.2790405f)); 
        return rect;
    }

    private Rectangle2D decodeRect3() {
            rect.setRect(decodeX(1.2212919f), 
                         decodeY(1.6047981f), 
                         decodeX(1.270335f) - decodeX(1.2212919f), 
                         decodeY(1.3876263f) - decodeY(1.6047981f)); 
        return rect;
    }

    private Rectangle2D decodeRect4() {
            rect.setRect(decodeX(1.2643541f), 
                         decodeY(1.5542929f), 
                         decodeX(1.6315789f) - decodeX(1.2643541f), 
                         decodeY(1.5997474f) - decodeY(1.5542929f)); 
        return rect;
    }

    private Rectangle2D decodeRect5() {
            rect.setRect(decodeX(1.6267943f), 
                         decodeY(1.3888888f), 
                         decodeX(1.673445f) - decodeX(1.6267943f), 
                         decodeY(1.6085858f) - decodeY(1.3888888f)); 
        return rect;
    }

    private Rectangle2D decodeRect6() {
            rect.setRect(decodeX(1.3684211f), 
                         decodeY(1.6111112f), 
                         decodeX(1.4210527f) - decodeX(1.3684211f), 
                         decodeY(1.7777778f) - decodeY(1.6111112f)); 
        return rect;
    }

    private Rectangle2D decodeRect7() {
            rect.setRect(decodeX(1.4389952f), 
                         decodeY(1.7209597f), 
                         decodeX(1.7882775f) - decodeX(1.4389952f), 
                         decodeY(1.7765152f) - decodeY(1.7209597f)); 
        return rect;
    }

    private Rectangle2D decodeRect8() {
            rect.setRect(decodeX(1.5645933f), 
                         decodeY(1.4078283f), 
                         decodeX(1.7870812f) - decodeX(1.5645933f), 
                         decodeY(1.5239899f) - decodeY(1.4078283f)); 
        return rect;
    }
    ...
    private RoundRectangle2D decodeRoundRect3() {
        roundRect.setRoundRect(decodeX(1.0f), 
                               decodeY(1.6111112f), 
                               decodeX(2.0f) - decodeX(1.0f), 
                               decodeY(2.0f) - decodeY(1.6111112f), 
                               6.0f, 6.0f); 
        return roundRect;
    }

    private Rectangle2D decodeRect9() {
            rect.setRect(decodeX(1.3815789f), 
                         decodeY(1.6111112f), 
                         decodeX(1.4366028f) - decodeX(1.3815789f), 
                         decodeY(1.7739899f) - decodeY(1.6111112f)); 
        return rect;
    }

    private Rectangle2D decodeRect10() {
            rect.setRect(decodeX(1.7918661f), 
                         decodeY(1.7752526f), 
                         decodeX(1.8349283f) - decodeX(1.7918661f), 
                         decodeY(1.4217172f) - decodeY(1.7752526f)); 
        return rect;
    }
