...
final class SplitPaneDividerPainter extends AbstractRegionPainter {
    ...
    private RoundRectangle2D decodeRoundRect1() {
        roundRect.setRoundRect(decodeX(1.05f), 
                               decodeY(1.3f), 
                               decodeX(1.95f) - decodeX(1.05f), 
                               decodeY(1.8f) - decodeY(1.3f), 
                               3.6666667f, 3.6666667f); 
        return roundRect;
    }

    private RoundRectangle2D decodeRoundRect2() {
        roundRect.setRoundRect(decodeX(1.1f), 
                               decodeY(1.4f), 
                               decodeX(1.9f) - decodeX(1.1f), 
                               decodeY(1.7f) - decodeY(1.4f), 
                               4.0f, 4.0f); 
        return roundRect;
    }

    private RoundRectangle2D decodeRoundRect3() {
        roundRect.setRoundRect(decodeX(1.3f), 
                               decodeY(1.1428572f), 
                               decodeX(1.7f) - decodeX(1.3f), 
                               decodeY(1.8214285f) - decodeY(1.1428572f), 
                               4.0f, 4.0f); 
        return roundRect;
    }

    private Rectangle2D decodeRect2() {
            rect.setRect(decodeX(1.4f), 
                         decodeY(1.1785715f), 
                         decodeX(1.6f) - decodeX(1.4f), 
                         decodeY(1.7678571f) - decodeY(1.1785715f)); 
        return rect;
    }
