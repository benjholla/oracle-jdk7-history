...
final class TextAreaPainter extends AbstractRegionPainter {
    ...
    private Rectangle2D decodeRect3() {
            rect.setRect(decodeX(0.6666667f), 
                         decodeY(0.4f), 
                         decodeX(2.3333333f) - decodeX(0.6666667f), 
                         decodeY(1.0f) - decodeY(0.4f)); 
        return rect;
    }
    ...
    private Rectangle2D decodeRect5() {
            rect.setRect(decodeX(0.6666667f), 
                         decodeY(1.0f), 
                         decodeX(1.0f) - decodeX(0.6666667f), 
    ...
    private Rectangle2D decodeRect6() {
            rect.setRect(decodeX(0.6666667f), 
                         decodeY(2.3333333f), 
                         decodeX(2.3333333f) - decodeX(0.6666667f), 
                         decodeY(2.0f) - decodeY(2.3333333f)); 
        return rect;
    }

    private Rectangle2D decodeRect7() {
            rect.setRect(decodeX(2.0f), 
                         decodeY(1.0f), 
                         decodeX(2.3333333f) - decodeX(2.0f), 
                         decodeY(2.0f) - decodeY(1.0f)); 
        return rect;
    }
