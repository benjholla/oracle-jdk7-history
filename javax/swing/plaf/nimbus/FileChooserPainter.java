...
final class FileChooserPainter extends AbstractRegionPainter {
    ...
    private Rectangle2D decodeRect1() {
            rect.setRect(decodeX(1.0f), 
                         decodeY(1.0f), 
                         decodeX(2.0f) - decodeX(1.0f), 
    ...
    private Rectangle2D decodeRect2() {
            rect.setRect(decodeX(0.4f), 
                         decodeY(2.8f), 
                         decodeX(2.6f) - decodeX(0.4f), 
                         decodeY(3.0f) - decodeY(2.8f)); 
        return rect;
    }
    ...
    private Rectangle2D decodeRect3() {
            rect.setRect(decodeX(0.2f), 
                         decodeY(0.6f), 
                         decodeX(0.4f) - decodeX(0.2f), 
                         decodeY(0.8f) - decodeY(0.6f)); 
        return rect;
    }

    private Rectangle2D decodeRect4() {
            rect.setRect(decodeX(0.6f), 
                         decodeY(0.2f), 
                         decodeX(1.3333334f) - decodeX(0.6f), 
                         decodeY(0.4f) - decodeY(0.2f)); 
        return rect;
    }

    private Rectangle2D decodeRect5() {
            rect.setRect(decodeX(1.5f), 
                         decodeY(0.6f), 
                         decodeX(2.4f) - decodeX(1.5f), 
                         decodeY(0.8f) - decodeY(0.6f)); 
        return rect;
    }
    ...
    private Rectangle2D decodeRect6() {
            rect.setRect(decodeX(0.2f), 
                         decodeY(0.0f), 
                         decodeX(2.8f) - decodeX(0.2f), 
                         decodeY(2.2f) - decodeY(0.0f)); 
        return rect;
    }
    ...
    private Rectangle2D decodeRect9() {
            rect.setRect(decodeX(0.6f), 
                         decodeY(2.8f), 
                         decodeX(1.6666667f) - decodeX(0.6f), 
                         decodeY(3.0f) - decodeY(2.8f)); 
        return rect;
    }

    private Rectangle2D decodeRect10() {
            rect.setRect(decodeX(1.8333333f), 
                         decodeY(2.8f), 
                         decodeX(2.4f) - decodeX(1.8333333f), 
                         decodeY(3.0f) - decodeY(2.8f)); 
        return rect;
    }

    private Ellipse2D decodeEllipse1() {
        ellipse.setFrame(decodeX(0.6f), 
                         decodeY(2.4f), 
                         decodeX(0.8f) - decodeX(0.6f), 
                         decodeY(2.6f) - decodeY(2.4f)); 
        return ellipse;
    }
    ...
    private Ellipse2D decodeEllipse3() {
        ellipse.setFrame(decodeX(2.2f), 
                         decodeY(0.2f), 
                         decodeX(2.4f) - decodeX(2.2f), 
                         decodeY(0.4f) - decodeY(0.2f)); 
        return ellipse;
    }
    ...
    private Ellipse2D decodeEllipse4() {
        ellipse.setFrame(decodeX(2.2f), 
                         decodeY(1.0f), 
                         decodeX(2.4f) - decodeX(2.2f), 
                         decodeY(1.1666666f) - decodeY(1.0f)); 
        return ellipse;
    }
    ...
    private Ellipse2D decodeEllipse5() {
        ellipse.setFrame(decodeX(2.2f), 
                         decodeY(1.6666667f), 
                         decodeX(2.4f) - decodeX(2.2f), 
                         decodeY(1.8333333f) - decodeY(1.6666667f)); 
        return ellipse;
    }
    ...
    private Rectangle2D decodeRect11() {
            rect.setRect(decodeX(0.8f), 
                         decodeY(2.2f), 
                         decodeX(1.0f) - decodeX(0.8f), 
                         decodeY(2.6f) - decodeY(2.2f)); 
        return rect;
    }

    private Rectangle2D decodeRect12() {
            rect.setRect(decodeX(1.1666666f), 
                         decodeY(2.2f), 
                         decodeX(1.3333334f) - decodeX(1.1666666f), 
                         decodeY(2.6f) - decodeY(2.2f)); 
        return rect;
    }
    ...
    private Rectangle2D decodeRect13() {
            rect.setRect(decodeX(1.5f), 
                         decodeY(2.2f), 
                         decodeX(1.6666667f) - decodeX(1.5f), 
                         decodeY(2.6f) - decodeY(2.2f)); 
        return rect;
    }
    ...
    private Rectangle2D decodeRect14() {
            rect.setRect(decodeX(0.8f), 
                         decodeY(2.6f), 
                         decodeX(2.2f) - decodeX(0.8f), 
                         decodeY(2.8f) - decodeY(2.6f)); 
        return rect;
    }

    private Rectangle2D decodeRect15() {
            rect.setRect(decodeX(0.36153847f), 
                         decodeY(2.3576922f), 
                         decodeX(0.63461536f) - decodeX(0.36153847f), 
                         decodeY(2.6807692f) - decodeY(2.3576922f)); 
        return rect;
    }

    private Rectangle2D decodeRect16() {
            rect.setRect(decodeX(2.376923f), 
                         decodeY(2.3807693f), 
                         decodeX(2.6384616f) - decodeX(2.376923f), 
                         decodeY(2.6846154f) - decodeY(2.3807693f)); 
        return rect;
    }
    ...
    private Rectangle2D decodeRect17() {
            rect.setRect(decodeX(0.4f), 
                         decodeY(2.4f), 
                         decodeX(0.6f) - decodeX(0.4f), 
                         decodeY(2.6f) - decodeY(2.4f)); 
        return rect;
    }

    private Rectangle2D decodeRect18() {
            rect.setRect(decodeX(2.4f), 
                         decodeY(2.4f), 
                         decodeX(2.6f) - decodeX(2.4f), 
                         decodeY(2.6f) - decodeY(2.4f)); 
        return rect;
    }
    ...
    private Rectangle2D decodeRect19() {
            rect.setRect(decodeX(1.6666667f), 
                         decodeY(1.6666667f), 
                         decodeX(2.2f) - decodeX(1.6666667f), 
                         decodeY(2.2f) - decodeY(1.6666667f)); 
        return rect;
    }
    ...
    private Rectangle2D decodeRect20() {
            rect.setRect(decodeX(1.8333333f), 
                         decodeY(1.8333333f), 
                         decodeX(2.0f) - decodeX(1.8333333f), 
                         decodeY(2.0f) - decodeY(1.8333333f)); 
        return rect;
    }
    ...
    private Rectangle2D decodeRect21() {
            rect.setRect(decodeX(1.1666666f), 
                         decodeY(1.8333333f), 
                         decodeX(1.3333334f) - decodeX(1.1666666f), 
                         decodeY(2.6f) - decodeY(1.8333333f)); 
        return rect;
    }
    ...
    private Rectangle2D decodeRect22() {
            rect.setRect(decodeX(0.2f), 
                         decodeY(0.0f), 
                         decodeX(3.0f) - decodeX(0.2f), 
                         decodeY(2.8f) - decodeY(0.0f)); 
        return rect;
    }
    ...
    private Rectangle2D decodeRect23() {
            rect.setRect(decodeX(0.4f), 
                         decodeY(0.2f), 
                         decodeX(2.8f) - decodeX(0.4f), 
                         decodeY(2.6f) - decodeY(0.2f)); 
        return rect;
    }
    ...
    private Rectangle2D decodeRect24() {
            rect.setRect(decodeX(1.0f), 
                         decodeY(0.6f), 
                         decodeX(1.3333334f) - decodeX(1.0f), 
                         decodeY(0.8f) - decodeY(0.6f)); 
        return rect;
    }
    ...
    private Rectangle2D decodeRect25() {
            rect.setRect(decodeX(1.5f), 
                         decodeY(1.3333334f), 
                         decodeX(2.4f) - decodeX(1.5f), 
                         decodeY(1.5f) - decodeY(1.3333334f)); 
        return rect;
    }
    ...
    private Ellipse2D decodeEllipse8() {
        ellipse.setFrame(decodeX(0.6f), 
                         decodeY(0.8f), 
                         decodeX(2.2f) - decodeX(0.6f), 
                         decodeY(2.4f) - decodeY(0.8f)); 
        return ellipse;
    }

    private Ellipse2D decodeEllipse9() {
        ellipse.setFrame(decodeX(0.8f), 
                         decodeY(1.0f), 
                         decodeX(2.0f) - decodeX(0.8f), 
                         decodeY(2.2f) - decodeY(1.0f)); 
        return ellipse;
    }
    ...
    private Rectangle2D decodeRect28() {
            rect.setRect(decodeX(1.5f), 
                         decodeY(1.3333334f), 
                         decodeX(1.8333333f) - decodeX(1.5f), 
                         decodeY(1.5f) - decodeY(1.3333334f)); 
        return rect;
    }
    ...
    private Rectangle2D decodeRect33() {
            rect.setRect(decodeX(0.8f), 
                         decodeY(0.6f), 
                         decodeX(1.1666666f) - decodeX(0.8f), 
                         decodeY(0.8f) - decodeY(0.6f)); 
        return rect;
    }

    private Rectangle2D decodeRect34() {
            rect.setRect(decodeX(1.3333334f), 
                         decodeY(0.6f), 
                         decodeX(2.2f) - decodeX(1.3333334f), 
                         decodeY(0.8f) - decodeY(0.6f)); 
        return rect;
    }
    ...
    private Rectangle2D decodeRect35() {
            rect.setRect(decodeX(1.3333334f), 
                         decodeY(1.0f), 
                         decodeX(2.0f) - decodeX(1.3333334f), 
                         decodeY(1.1666666f) - decodeY(1.0f)); 
        return rect;
    }
    ...
    private Rectangle2D decodeRect45() {
            rect.setRect(decodeX(0.8f), 
                         decodeY(1.1666666f), 
                         decodeX(1.1666666f) - decodeX(0.8f), 
                         decodeY(1.3333334f) - decodeY(1.1666666f)); 
        return rect;
    }
    ...
    private Rectangle2D decodeRect47() {
            rect.setRect(decodeX(0.8f), 
                         decodeY(1.5f), 
                         decodeX(1.1666666f) - decodeX(0.8f), 
                         decodeY(1.6666667f) - decodeY(1.5f)); 
        return rect;
    }
