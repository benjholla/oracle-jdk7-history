...
final class SliderTrackPainter extends AbstractRegionPainter {
    ...
    private RoundRectangle2D decodeRoundRect1() {
        roundRect.setRoundRect(decodeX(0.2f), 
                               decodeY(1.6f), 
                               decodeX(2.8f) - decodeX(0.2f), 
                               decodeY(2.8333333f) - decodeY(1.6f), 
                               8.705882f, 8.705882f); 
        return roundRect;
    }

    private RoundRectangle2D decodeRoundRect2() {
        roundRect.setRoundRect(decodeX(0.0f), 
                               decodeY(1.0f), 
                               decodeX(3.0f) - decodeX(0.0f), 
                               decodeY(2.0f) - decodeY(1.0f), 
                               4.9411764f, 4.9411764f); 
        return roundRect;
    }

    private RoundRectangle2D decodeRoundRect3() {
        roundRect.setRoundRect(decodeX(0.29411763f), 
                               decodeY(1.2f), 
                               decodeX(2.7058823f) - decodeX(0.29411763f), 
                               decodeY(2.0f) - decodeY(1.2f), 
                               4.0f, 4.0f); 
        return roundRect;
    }
    ...
    private RoundRectangle2D decodeRoundRect4() {
        roundRect.setRoundRect(decodeX(0.2f), 
                               decodeY(1.6f), 
                               decodeX(2.8f) - decodeX(0.2f), 
                               decodeY(2.1666667f) - decodeY(1.6f), 
                               8.705882f, 8.705882f); 
        return roundRect;
    }

    private RoundRectangle2D decodeRoundRect5() {
        roundRect.setRoundRect(decodeX(0.28823528f), 
                               decodeY(1.2f), 
                               decodeX(2.7f) - decodeX(0.28823528f), 
                               decodeY(2.0f) - decodeY(1.2f), 
                               4.0f, 4.0f); 
        return roundRect;
    }
