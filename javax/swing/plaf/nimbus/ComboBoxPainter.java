...
final class ComboBoxPainter extends AbstractRegionPainter {
    ...
    private RoundRectangle2D decodeRoundRect1() {
        roundRect.setRoundRect(decodeX(0.06666667f), 
                               decodeY(0.075f), 
                               decodeX(2.9684212f) - decodeX(0.06666667f), 
                               decodeY(2.925f) - decodeY(0.075f), 
                               13.0f, 13.0f); 
        return roundRect;
    }

    private Rectangle2D decodeRect1() {
            rect.setRect(decodeX(1.4385965f), 
                         decodeY(1.4444444f), 
                         decodeX(1.4385965f) - decodeX(1.4385965f), 
                         decodeY(1.4444444f) - decodeY(1.4444444f)); 
        return rect;
    }
